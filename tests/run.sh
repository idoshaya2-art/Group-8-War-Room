...
for t in audit/wave1 audit/wave1-clean audit/wave2 audit/wave3 audit/wave4 audit/wave4-currency audit/wave5 audit/surfaces audit/rt_xss audit/planv6 audit/ingest audit/floor-overview audit/sale-goals; do
  node "$t.cjs" || fail=1
done
echo
